        ...
        <section className="bg-gray-900 py-20 px-6 flex justify-center">
          <div className="bg-gray-800 rounded-lg shadow-lg p-10 text-center max-w-2xl w-full">
            ...
            <div className="flex justify-center space-x-4 mt-6">
              {/* Get Started Button */}
              <button className="flex items-center space-x-2 bg-purple-600 hover:bg-purple-700 text-white font-medium py-2 px-6 rounded-lg">
              ...
              {/* Take a Tour Button */}
              <button className="border border-gray-500 text-gray-300 font-medium py-2 px-6 rounded-lg hover:bg-gray-700">
                Take a Tour
              </button>
            </div>
          </div>
